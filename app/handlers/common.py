...
GENERAL_GUIDE = (
    ...
    '  /set supervisor [va_tg_id] [supervisor_tg_id]\n'
    '  /set rate [va_tg_id] [hourly_amount]\n\n'
...
ROLE_HELP = {
    ...
    Role.SUPERVISOR: (
        ...
        'How to get a Telegram ID: ask them to message @userinfobot\n\n'
        'Assign supervisor:  /set supervisor [va_tg_id] [supervisor_tg_id]\n'
        'Set hourly rate:    /set rate [va_tg_id] [amount]\n'
    ...
    Role.BUSINESS_MANAGER: (
        ...
        '  Via menu: /menu → Add User (guided with buttons)\n\n'
        'Configure team:\n'
        '  /set supervisor [va_tg_id] [sup_tg_id]     → assign supervisor\n'
        '  /set rate [va_tg_id] [amount]              → set hourly rate\n'
